...
from botocore.retries.base import BaseRetryBackoff as BaseRetryBackoff, BaseRetryableChecker as BaseRetryableChecker
...
class RetryContext:
    ...
    request_context: Any = ...
    def __init__(self, attempt_number: Any, operation_model: Optional[Any] = ..., parsed_response: Optional[Any] = ..., http_response: Optional[Any] = ..., caught_exception: Optional[Any] = ..., request_context: Optional[Any] = ...) -> None:
        ...
...
class TransientRetryableChecker(BaseRetryableChecker):
    def __init__(self, transient_error_codes: Optional[Any] = ..., transient_status_codes: Optional[Any] = ..., transient_exception_cls: Optional[Any] = ...) -> None:
        ...
