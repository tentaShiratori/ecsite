...
class DeferredRefreshableToken:
    def __init__(self, method: Any, refresh_using: Callable[[], FrozenAuthToken], time_fetcher: Callable[[], datetime.datetime] = ...) -> None:
        ...
...
class SSOTokenProvider:
    ...
    def __init__(self, session: Session, cache: Optional[JSONFileCache] = ..., time_fetcher: Callable[[], datetime.datetime] = ..., profile_name: Optional[str] = ...) -> None:
        ...
