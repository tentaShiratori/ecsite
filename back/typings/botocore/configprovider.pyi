...
class ConfigChainFactory:
    ...
    def create_config_chain(self, instance_name: Optional[Any] = ..., env_var_names: Optional[Any] = ..., config_property_names: Optional[Any] = ..., default: Optional[Any] = ..., conversion_func: Optional[Any] = ...) -> Any:
        ...
...
class SmartDefaultsConfigStoreFactory:
    def __init__(self, default_config_resolver: DefaultConfigResolver, imds_region_provider: IMDSRegionProvider) -> None:
        ...
    
    def merge_smart_defaults(self, config_store: ConfigValueStore, mode: str, region_name: str) -> None:
        ...
...
class ChainProvider(BaseProvider):
    def __init__(self, providers: Optional[Any] = ..., conversion_func: Optional[Any] = ...) -> None:
        ...
...
class SectionConfigProvider(BaseProvider):
    def __init__(self, section_name: Any, session: Any, override_providers: Optional[Any] = ...) -> None:
        ...
