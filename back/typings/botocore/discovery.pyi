...
class EndpointDiscoveryManager:
    def __init__(self, client: Any, cache: Optional[Any] = ..., current_time: Optional[Any] = ..., always_discover: bool = ...) -> None:
        ...
...
class EndpointDiscoveryHandler:
    ...
    def handle_retries(self, request_dict: Any, response: Any, operation: Any, **kwargs: Any) -> Any:
        ...
