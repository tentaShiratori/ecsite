...
class APICallEvent(BaseMonitorEvent):
    ...
    def __init__(self, service: Any, operation: Any, timestamp: Any, latency: Optional[Any] = ..., attempts: Optional[Any] = ..., retries_exceeded: bool = ...) -> None:
        ...
...
class APICallAttemptEvent(BaseMonitorEvent):
    ...
    parsed_error: Any = ...
    wire_exception: Any = ...
    def __init__(self, service: Any, operation: Any, timestamp: Any, latency: Optional[Any] = ..., url: Optional[Any] = ..., http_status_code: Optional[Any] = ..., request_headers: Optional[Any] = ..., response_headers: Optional[Any] = ..., parsed_error: Optional[Any] = ..., wire_exception: Optional[Any] = ...) -> None:
        ...
