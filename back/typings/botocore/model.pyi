...
class Shape:
    ...
    def __init__(self, shape_name: str, shape_model: Dict[str, Any], shape_resolver: Optional[ShapeResolver] = ...) -> None:
        ...
...
class ServiceModel:
    def __init__(self, service_description: Dict[str, Any], service_name: Optional[str] = ...) -> None:
        ...
    
    def shape_for(self, shape_name: str, member_traits: Optional[Dict[str, Any]] = ...) -> Shape:
        ...
...
class OperationModel:
    def __init__(self, operation_model: Dict[str, Any], service_model: ServiceModel, name: Optional[str] = ...) -> None:
        ...
...
class ShapeResolver:
    ...
    def get_shape_by_name(self, shape_name: str, member_traits: Optional[Dict[str, Any]] = ...) -> Shape:
        ...
