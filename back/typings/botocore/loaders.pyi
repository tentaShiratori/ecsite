...
class Loader:
    ...
    def __init__(self, extra_search_paths: Optional[Iterable[str]] = ..., file_loader: Optional[JSONFileLoader] = ..., cache: Optional[Any] = ..., include_default_search_paths: bool = ..., include_default_extras: bool = ...) -> None:
        ...
    ...
    def load_service_model(self, service_name: str, type_name: str, api_version: Optional[Any] = ...) -> Any:
        ...
...
class ExtrasProcessor:
    def process(self, original_model: Mapping[str, Any], extra_models: Iterable[Mapping[str, Any]]) -> None:
        ...
