...
def create_credential_resolver(session: Session, cache: Optional[Dict[str, Any]] = ..., region_name: Optional[str] = ...) -> CredentialResolver:
    ...

class ProfileProviderBuilder:
    def __init__(self, session: Session, cache: Optional[Dict[str, Any]] = ..., region_name: Optional[str] = ..., sso_token_cache: Optional[Dict[str, Any]] = ...) -> None:
        ...
    
    def providers(self, profile_name: str, disable_env_vars: bool = ...) -> List[CredentialProvider]:
        ...
...
class Credentials:
    ...
    token: str = ...
    method: str = ...
    def __init__(self, access_key: str, secret_key: str, token: Optional[str] = ..., method: Optional[str] = ...) -> None:
        ...
...
class RefreshableCredentials(Credentials):
    method: Any = ...
    def __init__(self, access_key: str, secret_key: str, token: str, expiry_time: Any, refresh_using: Any, method: str, time_fetcher: Any = ...) -> None:
        ...
...
class CachedCredentialFetcher:
    ...
    def __init__(self, cache: Optional[Any] = ..., expiry_window_seconds: Optional[Any] = ...) -> None:
        ...
...
class BaseAssumeRoleCredentialFetcher(CachedCredentialFetcher):
    def __init__(self, client_creator: Any, role_arn: str, extra_args: Optional[Any] = ..., cache: Optional[Any] = ..., expiry_window_seconds: Optional[Any] = ...) -> None:
        ...
    


class AssumeRoleCredentialFetcher(BaseAssumeRoleCredentialFetcher):
    def __init__(self, client_creator: Any, source_credentials: Any, role_arn: str, extra_args: Optional[Any] = ..., mfa_prompter: Optional[Any] = ..., cache: Optional[Any] = ..., expiry_window_seconds: Optional[Any] = ...) -> None:
        ...
    


class AssumeRoleWithWebIdentityCredentialFetcher(BaseAssumeRoleCredentialFetcher):
    def __init__(self, client_creator: Any, web_identity_token_loader: Any, role_arn: str, extra_args: Optional[Any] = ..., cache: Optional[Any] = ..., expiry_window_seconds: Optional[Any] = ...) -> None:
        ...
...
class SharedCredentialProvider(CredentialProvider):
    ...
    SECRET_KEY: str = ...
    TOKENS: Any = ...
    def __init__(self, creds_filename: Any, profile_name: Optional[Any] = ..., ini_parser: Optional[Any] = ...) -> None:
        ...
...
class ConfigProvider(CredentialProvider):
    ...
    SECRET_KEY: str = ...
    TOKENS: Any = ...
    def __init__(self, config_filename: Any, profile_name: str, config_parser: Optional[Any] = ...) -> None:
        ...
...
class AssumeRoleProvider(CredentialProvider):
    ...
    cache: Any = ...
    def __init__(self, load_config: Callable[[], Dict[str, Any]], client_creator: Callable[..., Any], cache: Dict[str, Any], profile_name: str, prompter: Callable[..., Any] = ..., credential_sourcer: Optional[CanonicalNameCredentialSourcer] = ..., profile_provider_builder: Optional[Any] = ...) -> None:
        ...
...
class AssumeRoleWithWebIdentityProvider(CredentialProvider):
    ...
    CANONICAL_NAME: Any = ...
    cache: Any = ...
    def __init__(self, load_config: Any, client_creator: Any, profile_name: str, cache: Optional[Any] = ..., disable_env_vars: bool = ..., token_loader_cls: Optional[Any] = ...) -> None:
        ...
...
class ContainerProvider(CredentialProvider):
    ...
    def __init__(self, environ: Optional[Dict[str, str]] = ..., fetcher: Optional[Any] = ...) -> None:
        ...
...
class SSOCredentialFetcher(CachedCredentialFetcher):
    def __init__(self, start_url: Any, sso_region: Any, role_name: Any, account_id: Any, client_creator: Any, token_loader: Optional[Any] = ..., cache: Optional[Any] = ..., expiry_window_seconds: Optional[Any] = ..., token_provider: Optional[SSOTokenProvider] = ..., sso_session_name: Optional[str] = ...) -> None:
        ...
...
class SSOProvider(CredentialProvider):
    METHOD: str = ...
    cache: Any = ...
    def __init__(self, load_config: Any, client_creator: Any, profile_name: str, cache: Optional[Any] = ..., token_cache: Optional[Any] = ..., token_provider: Optional[SSOTokenProvider] = ...) -> None:
        ...
