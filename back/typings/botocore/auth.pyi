...
class SigV4QueryAuth(SigV4Auth):
    DEFAULT_EXPIRES: int = ...
    def __init__(self, credentials: _CredentialsUnion, service_name: str, region_name: str, expires: int = ...) -> None:
        ...
...
class HmacV1Auth(BaseSigner):
    ...
    def __init__(self, credentials: _CredentialsUnion, service_name: Optional[str] = ..., region_name: Optional[str] = ...) -> None:
        ...
    ...
    def canonical_string(self, method: str, split: SplitResult, headers: Mapping[str, Any], expires: Optional[int] = ..., auth_path: Optional[str] = ...) -> Any:
        ...
    
    def get_signature(self, method: str, split: SplitResult, headers: Mapping[str, Any], expires: Optional[int] = ..., auth_path: Optional[str] = ...) -> Any:
        ...
